...
void system_init(void)
{
    ...
    */
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "12, 'image_enhancement', '{\"dynamic\":{\"sDehaze\":{\"open\":{\"iDehazeLevel\":{\"range\":{\"max\":10,\"min\":0,\"step\":1},\"type\":\"range\"}}},\"sNoiseReduceMode\":{\"advanced\":{\"iSpatialDenoiseLevel\":{\"range\":"\
        ...
        "{\"image_enhancement\":[\"sNoiseReduceMode\",\"iDenoiseLevel\",\"iSpatialDenoiseLevel\",\"iTemporalDenoiseLevel\",\"sDehaze\",\"iDehazeLevel\",\"sGrayScaleMode\",\"sFEC\"]},\"static\":{\"sDIS\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"},\"sDehaze\":"\
        "{\"options\":[\"open\",\"close\",\"auto\"],\"type\":\"options\"},\"sFEC\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"},\"sGrayScaleMode\":{\"options\":[\"[0-255]\",\"[16-235]\"],\"type\":\"options\"},\"sNoiseReduceMode\":{\"options\":"\
        "[\"close\",\"general\",\"advanced\"],\"type\":\"options\"}}}'"));
