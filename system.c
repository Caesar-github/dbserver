...
void system_init(void)
{
    ...
    */
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "8, 'image_exposure', '{\"dynamic\":{\"sIrisType\":{\"auto\":{\"iAutoIrisLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}}},\"layout\":{\"image_exposure\":[\"sIrisType\",\"iAutoIrisLevel\","\
        "\"sExposureTime\",\"iExposureGain\"]},\"static\":{\"iExposureGain\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"sExposureTime\":{\"options\":[\"1\",\"1/3\",\"1/6\",\"1/12\",\"1/25\",\"1/50\",\"1/100\",\"1/150\",\"1/200\",\"1/250\",\"1/500\",\"1/750\","\
        "\"1/1000\",\"1/2000\",\"1/4000\",\"1/10000\",\"1/100000\"],\"type\":\"options\"},\"sIrisType\":{\"options\":[\"auto\",\"manual\"],\"type\":\"options\"}}}'"));
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "9, 'image_night_to_day', '{\"dynamic\":{\"sNightToDay\":{\"alarmInputTrigger\":{\"sIrcutFilterAction\":{\"options\":[\"day\",\"night\"],\"type\":\"options\"}},\"auto\":{\"iNightToDayFilterLevel\":{\"options\":[0,1,2,3,4,5,6,7],\"type\":\"options\"},"\
        "\"iNightToDayFilterTime\":{\"range\":{\"max\":120,\"min\":5,\"step\":1},\"type\":\"range\"}},\"manual\":{\"sBeginTime\":{\"input\":\"time\",\"type\":\"input\"},\"sEndTime\":{\"input\":\"time\",\"type\":\"input\"}}},\"sOverexposeSuppress\":{\"open\":{\"sOverexposeSuppressType\":"\
        "{\"options\":[\"auto\",\"manual\"],\"type\":\"options\"}}},\"sOverexposeSuppressType\":{\"manual\":{\"iDistanceLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}}},\"layout\":{\"image_night_to_day\":[\"sNightToDay\",\"iNightToDayFilterLevel\","\
        "\"iNightToDayFilterTime\",\"sBeginTime\",\"sEndTime\",\"sIrcutFilterAction\",\"sOverexposeSuppress\",\"sOverexposeSuppressType\",\"iDistanceLevel\"]},\"static\":{\"sNightToDay\":{\"options\":[\"day\",\"night\",\"auto\",\"manual\",\"alarmInputTrigger\"],\"type\":\"options\"},"\
        "\"sOverexposeSuppress\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"}}}'"));
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "10, 'image_blc', '{\"dynamic\":{\"sBLCRegion\":{\"close\":{\"sHDR\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"},\"sWDR\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"}}},\"sHDR\":{\"open\":{\"iHDRLevel\":"\
        "{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}},\"sHLC\":{\"open\":{\"iHLCLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}},\"sWDR\":{\"open\":{\"iWDRLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}}},"\
        "\"layout\":{\"image_blc\":[\"sBLCRegion\",\"sWDR\",\"iWDRLevel\",\"sHDR\",\"iHDRLevel\",\"sHLC\",\"iHLCLevel\",\"iPositionX\",\"iPositionY\",\"iBLCRegionWidth\",\"iBLCRegionHeight\"]},\"static\":{\"sBLCRegion\":{\"options\":[\"close\",\"up\",\"down\",\"left\",\"right\","\
        "\"center\",\"customize\"],\"type\":\"options\"},\"sHLC\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"}}}'"));
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "11, 'image_white_blance', '{\"dynamic\":{\"sWhiteBlanceStyle\":{\"manualWhiteBalance\":{\"iWhiteBalanceBlue\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iWhiteBalanceRed\":{\"range\":{\"max\":100,\"min\":"\
        "0,\"step\":1},\"type\":\"range\"}}}},\"layout\":{\"image_white_blance\":[\"sWhiteBlanceStyle\",\"iWhiteBalanceRed\",\"iWhiteBalanceBlue\"]},\"static\":{\"sWhiteBlanceStyle\":{\"options\":[\"manualWhiteBalance\",\"autoWhiteBalance1\",\"autoWhiteBalance2\",\"lockingWhiteBalance\","\
        "\"fluorescentLamp\",\"incandescent\",\"warmLight\",\"naturalLight\"],\"type\":\"options\"}}}'"));
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "12, 'image_enhancement', '{\"dynamic\":{\"sDehaze\":{\"open\":{\"iDehazeLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}},\"sNoiseReduceMode\":{\"advanced\":{\"iSpatialDenoiseLevel\":{\"range\":"\
        "{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iTemporalDenoiseLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}},\"general\":{\"iDenoiseLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}}},\"layout\":"\
        "{\"image_enhancement\":[\"sNoiseReduceMode\",\"iDenoiseLevel\",\"iSpatialDenoiseLevel\",\"iTemporalDenoiseLevel\",\"sDehaze\",\"iDehazeLevel\",\"sDIS\",\"sGrayScaleMode\",\"sFEC\"]},\"static\":{\"sDIS\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"},\"sDehaze\":"\
        "{\"options\":[\"open\",\"close\",\"auto\"],\"type\":\"options\"},\"sFEC\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"},\"sGrayScaleMode\":{\"options\":[\"[0-255]\",\"[16-235]\"],\"type\":\"options\"},\"sNoiseReduceMode\":{\"options\":[\"close\",\"general\","\
        "\"advanced\"],\"type\":\"options\"}}}'"));
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "13, 'image_video_adjustment', '{\"layout\":{\"image_video_adjustment\":[\"sImageFlip\",\"sSceneMode\",\"sPowerLineFrequencyMode\"]},\"static\":{\"sImageFlip\":{\"options\":[\"leftRight\",\"upDown\",\"center\",\"close\"],"\
        "\"type\":\"options\"},\"sPowerLineFrequencyMode\":{\"options\":[\"PAL(50HZ)\",\"NTSC(60HZ)\"],\"type\":\"options\"},\"sSceneMode\":{\"options\":[\"indoor\",\"outdoor\"],\"type\":\"options\"}}}'"));
