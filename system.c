...
void system_init(void)
{
    ...
    */
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "0, 'webPage', '{\"auth\":4,\"item\":[{\"auth\":4,\"name\":\"preview\"},{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":0,\"name\":\"delete\"}],\"name\":\"videoRecord\"},{\"auth\":4,\"item\":[{\"auth\":0,\"name\":"\
        "\"delete\"}],\"name\":\"pictureRecord\"}],\"name\":\"download\"},{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":1,\"name\":\"modify\"}],\"name\":\"ListManagement\"},{\"auth\":1,\"name\":\"AddOne\"},{\"auth\":1,\"name\":\"BatchInput\"}],\"name\":"\
        "\"MemberList\"},{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":0,\"name\":\"modify\"}],\"name\":\"SnapShot\"}],\"name\":\"SnapShot\"},{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":0,\"name\":\"modify\"}],\"name\":\"Control\"}],\"name\":\"Control\"},{\"auth\":1,"\
        "\"item\":[{\"auth\":1,\"name\":\"ParaConfig\"}],\"name\":\"Config\"}],\"name\":\"face\"},{\"auth\":-1,\"item\":[{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"FacePara\"},{\"auth\":1,\"name\":\"ROI\"}],\"name\":\"Config\"}],\"name\":\"face-para\"},{\"auth\":-1,\"item\":["\
        "{\"auth\":4,\"item\":[{\"auth\":4,\"item\":[{\"auth\":1,\"name\":\"modify\"}],\"name\":\"MemberList\"},{\"auth\":1,\"name\":\"AddOne\"},{\"auth\":1,\"name\":\"BatchInput\"},{\"auth\":4,\"item\":[{\"auth\":0,\"name\":\"modify\"}],\"name\":\"SnapShot\"},{\"auth\":4,\"item\":["\
        "{\"auth\":0,\"name\":\"modify\"}],\"name\":\"Control\"}],\"name\":\"Manage\"}],\"name\":\"face-manage\"},{\"auth\":1,\"item\":[{\"auth\":1,\"item\":[{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"basic\"},{\"auth\":1,\"name\":\"time\"}],\"name\":\"Settings\"},{\"auth\":1,\"item\":"\
        "[{\"auth\":1,\"name\":\"upgrade\"},{\"auth\":-1,\"name\":\"log\"}],\"name\":\"Maintain\"},{\"auth\":-1,\"item\":[{\"auth\":-1,\"name\":\"authentication\"},{\"auth\":-1,\"name\":\"ipAddrFilter\"},{\"auth\":-1,\"name\":\"securityService\"}],\"name\":\"Security\"},{\"auth\":0,"\
        "\"name\":\"User\"}],\"name\":\"System\"},{\"auth\":1,\"item\":[{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"TCPIP\"},{\"auth\":-1,\"name\":\"DDNS\"},{\"auth\":-1,\"name\":\"PPPoE\"},{\"auth\":1,\"name\":\"Port\"},{\"auth\":-1,\"name\":\"uPnP\"}],\"name\":\"Basic\"},{\"auth\":1,"\
        "\"item\":[{\"auth\":1,\"name\":\"Wi-Fi\"},{\"auth\":-1,\"name\":\"SMTP\"},{\"auth\":-1,\"name\":\"FTP\"},{\"auth\":-1,\"name\":\"eMail\"},{\"auth\":-1,\"name\":\"Cloud\"},{\"auth\":-1,\"name\":\"Protocol\"},{\"auth\":-1,\"name\":\"QoS\"},{\"auth\":-1,\"name\":\"Https\"}],\"name\":"\
        "\"Advanced\"}],\"name\":\"Network\"},{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"Encoder\"},{\"auth\":1,\"name\":\"AdvancedEncoder\"},{\"auth\":1,\"name\":\"ROI\"},{\"auth\":1,\"name\":\"RegionCrop\"}],\"name\":\"Video\"},{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"AudioParam\"}],"\
        "\"name\":\"Audio\"},{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"DisplaySettings\"},{\"auth\":1,\"name\":\"OSDSettings\"},{\"auth\":1,\"name\":\"PrivacyCover\"},{\"auth\":1,\"name\":\"PictureMask\"}],\"name\":\"Image\"},{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"MotionDetect\"},"\
        "{\"auth\":1,\"name\":\"IntrusionDetection\"},{\"auth\":-1,\"name\":\"AlarmInput\"},{\"auth\":-1,\"name\":\"AlarmOutput\"},{\"auth\":-1,\"name\":\"Abnormal\"}],\"name\":\"Event\"},{\"auth\":1,\"item\":[{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"VideoPlan\"},{\"auth\":1,\"name\":"\
        "\"ScreenshotPlan\"},{\"auth\":1,\"name\":\"ScreenshotPara\"}],\"name\":\"PlanSettings\"},{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"HardDiskManagement\"},{\"auth\":-1,\"name\":\"NAS\"},{\"auth\":-1,\"name\":\"CloudStorage\"}],\"name\":\"StorageManage\"}],\"name\":\"Storage\"},"\
        "{\"auth\":1,\"item\":[{\"auth\":1,\"name\":\"MarkCover\"},{\"auth\":-1,\"name\":\"MaskArea\"},{\"auth\":-1,\"name\":\"RuleSettings\"},{\"auth\":-1,\"name\":\"AdvancedCFG\"}],\"name\":\"Intel\"},{\"auth\":-1,\"item\":[{\"auth\":-1,\"name\":\"GateConfig\"},{\"auth\":-1,\"name\":"\
        "\"ScreenConfig\"}],\"name\":\"Peripherals\"}],\"name\":\"config\"},{\"auth\":4,\"name\":\"about\"}],\"name\":\"header\"}'"));
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "7, 'image_adjustment', '{\"layout\":{\"image_adjustment\":[\"iBrightness\",\"iContrast\",\"iSaturation\",\"iSharpness\",\"iFPS\",\"iHue\"]},\"static\":{\"iBrightness\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},"\
        "\"iContrast\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iHue\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iFPS\":{\"range\":{\"max\":60,\"min\":1,\"step\":1},\"type\":\"range\"},\"iSaturation\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iSharpness\":{\"range\":{\"max\":100,"\
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "10, 'image_blc', '{\"dynamic\":{\"sBLCRegion\":{\"close\":{\"sHDR\":{\"options\":[\"close\",\"HDR2\",\"HDR3\"],\"type\":\"options\"},\"sWDR\":{\"options\":[\"open\",\"close\"],\"type\":\"options\"}}},\"sHDR\":{\"open\":"\
        "{\"iHDRLevel\":{\"range\":{\"max\":100,\"min\":1,\"step\":1},\"type\":\"range\"}}},\"sHLC\":{\"open\":{\"iHLCLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}},\"sWDR\":{\"open\":{\"iWDRLevel\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},"\
    ...
    g_free(rkdb_insert(TABLE_SYSTEM_PARA, "id, name, para", "11, 'image_white_blance', '{\"dynamic\":{\"sWhiteBlanceStyle\":{\"manualWhiteBalance\":{\"iWhiteBalanceBlue\":{\"range\":{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"},\"iWhiteBalanceRed\":{\"range\":"\
        "{\"max\":100,\"min\":0,\"step\":1},\"type\":\"range\"}}}},\"layout\":{\"image_white_blance\":[\"sWhiteBlanceStyle\",\"iWhiteBalanceRed\",\"iWhiteBalanceBlue\"]},\"static\":{\"sWhiteBlanceStyle\":{\"options\":[\"manualWhiteBalance\",\"autoWhiteBalance\","\
